...
class store_classControl extends SystemControl{
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    showMessage($lang['feiwa_common_save_succ'],'index.php?app=store_class&feiwa=store_class');
                }else {
                    showMessage($lang['feiwa_common_save_fail']);
                }
            }
    ...
    public function store_class_delFeiwa(){
        ...
        showMessage($lang['feiwa_common_del_fail'],'index.php?app=store_class&feiwa=store_class');
    }
