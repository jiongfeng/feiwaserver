...
class goods_classControl extends SystemControl{
    private $links = array(
        array('url'=>'app=goods_class&feiwa=goods_class','lang'=>'feiwa_manage'),
    ...
    public function goods_class_importFeiwa(){
        ...
        if (chksubmit()){
            ...
            if (!empty($_FILES['csv']) && !empty($_FILES['csv']['name']) && $file_type == 'csv'){
                ...
                showMessage($lang['feiwa_common_op_succ'],'index.php?app=goods_class&feiwa=goods_class');
            }else {
    ...
    public function tag_resetFeiwa(){
        ...
        if(is_array($goods_class) and !empty($goods_class)) {
            ...
            if($return){
                ...
                showMessage($lang['feiwa_common_op_succ'], 'index.php?app=goods_class&feiwa=tag');
            }else{
                $this->log(L('feiwa_reset').'tag',0);
                showMessage($lang['feiwa_common_op_fail'], 'index.php?app=goods_class&feiwa=tag');
            }
        }else{
            $this->log(L('feiwa_reset').'tag',0);
