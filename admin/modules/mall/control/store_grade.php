...
class store_gradeControl extends SystemControl{
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    showMessage($lang['feiwa_common_save_succ'],'index.php?app=store_grade&feiwa=store_grade');
                }else {
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    showMessage($lang['feiwa_common_save_succ']);
                }else {
                    showMessage($lang['feiwa_common_save_fail']);
                }
            }
    ...
    public function store_grade_delFeiwa(){
        ...
        if (intval($_GET['sg_id']) > 0){
            ...
            showMessage($lang['feiwa_common_del_succ'],'index.php?app=store_grade&feiwa=store_grade');
        }else {
            showMessage($lang['feiwa_common_del_fail'],'index.php?app=store_grade&feiwa=store_grade');
        }
    }
