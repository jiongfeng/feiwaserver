    ...
    public function bill_cycyle_editFeiwa(){
        ...
        if (chksubmit()){
            ...
            if ($result){
                ...
                showMessage($lang['feiwa_common_save_succ'],'index.php?app=store&feiwa=bill_cycle');
            }else {
                $this->log('设置店铺结算周期['.$_POST['store_name'].']',1);
                showMessage($lang['feiwa_common_save_fail'],'index.php?app=store&feiwa=bill_cycle');
            }
        }
