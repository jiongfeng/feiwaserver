 ...
 */
(function($) {
    $.fn.feiwa_text_count = function(options,submit_function) {
        var settings = $.extend({}, {max: 140}, options);
        return this.each(function() {
            $(this).after('<span feiwa_type="commend_count"></div>');
            var message_item = $(this).next("[feiwa_type='commend_count']");
 ...
 */
(function($) {
    $.fn.feiwa_count = function(options) {
 ...
 */
(function($) {
    $.fn.feiwa_lazyload_init = function() {
        this.each(function() {
 ...
 */
;(function($) {
    $.fn.feiwa_gallery = function(options) {
