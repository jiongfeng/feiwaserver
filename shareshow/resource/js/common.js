 ...
 */
(function($) {
    $.fn.shareshow_form = function(options) {
...
(function($) {
    $.fn.shareshow_form_show = function(options) {
 ...
 */
(function($) {
    $.fn.shareshow_publish = function(options,submit_function) {
        var settings = $.extend({}, {max: 140,button_item:'#btn_publish_comment',allow_null:'false'}, options);
        $(this).after('<span id="_comment_count" feiwa_type="commend_count" class="commend_count"></div>');
        settings.message_item = $(this).next("[feiwa_type='commend_count']");
 ...
 */
(function($) {
    $.fn.shareshow_count = function(options) {
 ...
 */
(function($) {
    $.fn.shareshow_like = function(options) {
        ...
        function submit_like() {
            var item = $(this);
            $.getJSON("index.php?app=like&feiwa=like_save", { type: settings.type, like_id: item.attr("like_id") }, function(json){
                if(json.result == "true") {
                    if(settings.count_target == '') {
                        item.find("em").shareshow_count({type:"+"});
                    } else {
                        settings.count_target.shareshow_count({type:"+"});
                    }
                }
                $(".like_tooltips").hide();
 ...
 */
(function($) {
    $.fn.shareshow_lazyload = function() {
        var lazy_items = [];
        this.each(function() {
            var lazy_item = {
                object: $(this),
