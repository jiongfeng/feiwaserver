$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?app=member_order&feiwa=order_info',{key:key,order_id:getQueryString('order_id')}, function(result) {
        ...
        $.ajax({
            type: 'post',
            url: ApiUrl + "/index.php?app=member_order&feiwa=get_current_deliver",
